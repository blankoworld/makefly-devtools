...
[Version originale de la documentation](http://makefly.depotoi.re/documentation.html) (French original version)
...
For an example [0.2.1 version](http://makefly.depotoi.re/makefly_0.2.1.zip "Download Makefly 0.2.1").
